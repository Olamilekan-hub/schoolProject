...
export const config = {
  ...
  // Digital Persona Specific
  DIGITAL_PERSONA_ENABLED: process.env.DIGITAL_PERSONA_ENABLED === 'true',
  DIGITAL_PERSONA_MIN_QUALITY: parseInt(process.env.DIGITAL_PERSONA_MIN_QUALITY || '60'),
  DIGITAL_PERSONA_MATCH_THRESHOLD: parseInt(process.env.DIGITAL_PERSONA_MATCH_THRESHOLD || '75'),
